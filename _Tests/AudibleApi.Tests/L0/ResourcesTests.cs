...
".Trim();
		...
		public void ensure_no_caching()
		{
			...
			us.AudibleApiUri().ToString().Should().Be("https://api.audible.com/");
			us.AmazonApiUri().ToString().Should().Be("https://api.amazon.com/");
			us.AmazonLoginUri().ToString().Should().Be("https://www.amazon.com/");
...
".Trim();
			us.OAuthUrl().Should().Be(oauthExpected);
			us.RegisterDomain().Should().Be(".amazon.com");
			us.LanguageTag().Should().Be("en-US");
		}
	}
}
