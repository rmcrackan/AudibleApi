...
namespace Authentic.CaptchaPageTests
{
    ...
    public class ctor
    {
        ...
        public void null_img_throws()
            => Assert.ThrowsException<ArgumentNullException>(() => new CaptchaPage(ApiHttpClientMock.GetClient(), StaticSystemDateTime.Past, Locales.Us, "body", null, "pw"));

        [TestMethod]
        public void null_password_throws()
            => Assert.ThrowsException<ArgumentNullException>(() => new CaptchaPage(ApiHttpClientMock.GetClient(), StaticSystemDateTime.Past, Locales.Us, "body", new Uri("http://a.com"), null));

        [TestMethod]
        public void blank_password_throws()
        {
            Assert.ThrowsException<ArgumentException>(() => new CaptchaPage(ApiHttpClientMock.GetClient(), StaticSystemDateTime.Past, Locales.Us, "body", new Uri("http://a.com"), ""));
        ...
        public void valid_create()
        {
			...
			var page = new CaptchaPage(ApiHttpClientMock.GetClient(), StaticSystemDateTime.Past, Locales.Us, "<input name='a' value='z'>", uri, "pw");
    ...
    public class SubmitAsync
    {
        private CaptchaPage getPage()
			=> new CaptchaPage(ApiHttpClientMock.GetClient(), StaticSystemDateTime.Past, Locales.Us, "body", new Uri("http://a.com"), "pw");
        ...
        public async Task valid_param_calls_GetResultsPageAsync()
        {
			...
			var page = new CaptchaPage(ApiHttpClientMock.GetClient(responseToCaptureRequest), StaticSystemDateTime.Past, Locales.Us, "body", new Uri("http://a.com"), "pw");
