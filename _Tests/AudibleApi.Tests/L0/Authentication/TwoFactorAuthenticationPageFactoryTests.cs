...
namespace Authentic.ResultFactoryTests.TwoFactorAuthenticationPageFactoryTests
{
    ...
    public class CreateResultAsync
    {
        ...
        public async Task valid_returns_TwoFactorAuthenticationPage()
        {
            ...
            var _2faPage = await ResultFactory.TwoFactorAuthenticationPage.CreateResultAsync(ApiHttpClientMock.GetClient(AuthenticateResponse), StaticSystemDateTime.Past, response, new Dictionary<string, string>()) as TwoFactorAuthenticationPage;
